    ...
    createQuestions() {
      ...
      const questions = [
        new Question(idx_count, "Em uma situação de perigo, qual seria sua primeira reação?", [
          ...
          { text: "Busco liberdade para encontrar nova perspectiva", scores: [2, 0, 1, 3] },
        ]),
        new Question(idx_count++, "Qual ambiente você prefere para relaxar?", [
          ...
          { text: "No topo de uma montanha com vista infinita", scores: [2, 0, 1, 3] },
        ]),
        new Question(idx_count++, "Como você lida com conflitos entre amigos?", [
          ...
          { text: "Trago novas ideias para resolver o problema", scores: [2, 1, 0, 3] },
        ]),
        new Question(idx_count++, "Qual é seu maior medo?", [
          ...
          { text: "Ficar preso sem poder explorar o mundo", scores: [2, 1, 0, 3] },
        ]),
        new Question(idx_count++, "Em um grupo, você geralmente é:", [
          ...
          { text: "O visionário que traz novas perspectivas", scores: [2, 1, 0, 3] },
        ]),
        ...
        { text: "Viajar e conhecer novas culturas", scores: [2, 1, 0, 3] },
      ]),
        new Question(idx_count++, "Como você vê mudanças em sua vida?", [
          ...
          { text: "Vejo como oportunidades de crescimento", scores: [0, 2, 1, 3] },
        ]),
        new Question(idx_count++, "Seu objetivo de vida é:", [
          ...
          { text: "Inspirar outros a alcançarem seus sonhos", scores: [2, 1, 0, 3] },
        ]),
        new Question(idx_count++, "Em momentos de estresse, você:", [
          ...
          { text: "Procuro novas perspectivas e soluções", scores: [2, 1, 0, 3] },
        ]),
        new Question(idx_count++, "Qual poder elemental mais atrai você?", [
          ...
          { text: "Voar livre com o poder do vento", scores: [1, 2, 0, 3] },
        ]),
      ];
